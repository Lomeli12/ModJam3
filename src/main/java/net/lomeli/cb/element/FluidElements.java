...
public class FluidElements {
    ...
    public static void loadFluids(){
        ...
        fireFluid = new Fluid("liquidFireCrystal");//.setIcons(ModBlocks.shardBlock.getIcon(0, 0));
        waterFluid = new Fluid("liquidWaterCrystal");//.setIcons(ModBlocks.shardBlock.getIcon(0, 1));
        earthFluid = new Fluid("liquidEarthCrystal");//.setIcons(ModBlocks.shardBlock.getIcon(0, 2));
        airFluid = new Fluid("liquidAirCrystal");//.setIcons(ModBlocks.shardBlock.getIcon(0, 3));
        darkFluid = new Fluid("liquidDarkCrystal");//.setIcons(ModBlocks.shardBlock.getIcon(0, 4));
